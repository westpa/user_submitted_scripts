...
binsperdim=[5,5,2]   # You will have prod(binsperdim)+numberofdim*(2+2*splitIsolated)+activetarget bins total
pcoordlength=6 # length of the pcoord
PCA=False       # choose to do principal component analysis
maxcap=[100,100,100]	#these are in the order of the dimensions left is first dimension and right is second dimension
mincap=[0,0,0]
targetstate=[None,None,10]    #enter boundaries for target state or None if there is no target state in that dimension
